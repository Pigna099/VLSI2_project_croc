source ./openroad/scripts/setup_OpenRoad.tcl

source $CROC_DIR/openroad/scripts/init_tech.tcl

read_verilog $CROC_DIR/yosys/out/04_croc_chip_yosys.v
...
source $CROC_DIR/openroad/scripts/pin_placement_complete.tcl
...
source $CROC_DIR/openroad/scripts/global_connections.tcl
global_connect
